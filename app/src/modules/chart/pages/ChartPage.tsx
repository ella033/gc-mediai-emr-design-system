                ...
                <DragCard id="diagnosis-order">
                  <Card title="진단 및 처방" icon={<Icon name="pill" size={14} />}
                    ...
                    <div style={{ display: 'flex', gap: 12 }}>
                      <div style={{ flex: 1 }}><div className="section-label">진단</div><Input leftIcon="search" placeholder="KCD 코드 또는 질환명" inputSize="small" /><div className="dx-list"><div className="dx-item text-body1-dense"><span className="dx-badge primary">주</span> J06.9 급성 상기도감염 <button className="dx-remove"><Icon name="close" size={12} /></button></div><div className="dx-item text-body1-dense"><span className="dx-badge sub">부</span> R51 두통 <button className="dx-remove"><Icon name="close" size={12} /></button></div></div></div>
                      <div style={{ flex: 2 }}><div className="section-label">처방</div><table className="rx-table"><thead><tr><th>약품명</th><th className="c">용량</th><th className="c">횟수</th><th className="c">일수</th><th className="c">경로</th><th></th></tr></thead><tbody><tr><td className="fw text-body1-dense-medium">타이레놀 500mg</td><td className="c text-data-table">1T</td><td className="c text-data-table">3회</td><td className="c text-data-table">3일</td><td className="c">경구</td><td className="c"><button className="dx-remove"><Icon name="close" size={10} /></button></td></tr><tr><td className="fw text-body1-dense-medium">클로르페니라민 4mg</td><td className="c text-data-table">1T</td><td className="c text-data-table">2회</td><td className="c text-data-table">3일</td><td className="c">경구</td><td className="c"><button className="dx-remove"><Icon name="close" size={10} /></button></td></tr></tbody></table><button className="text-btn"><Icon name="plus" size={12} /> 약품 추가</button></div>
                    </div>
                  </Card>
                </DragCard>
              </Allotment.Pane>
                    ...
                    <Allotment.Pane minSize={180}>
                      <DragCard id="lab-result">
                        <Card title="검사 결과" icon={<Icon name="chart" size={14} />}>
                          <table className="rx-table"><thead><tr><th>항목</th><th className="c">결과</th><th className="c">판정</th></tr></thead><tbody><tr><td>WBC</td><td className="c text-data-table-bold" style={{color:'#DC2626'}}>11.2</td><td className="c"><Badge variant="solid" color="red" size="xsmall">H</Badge></td></tr><tr><td>RBC</td><td className="c text-data-table">4.85</td><td className="c"><Badge variant="solid" color="green" size="xsmall">N</Badge></td></tr></tbody></table>
                        </Card>
                      </DragCard>
                    </Allotment.Pane>
                  )}
